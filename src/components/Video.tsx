    ...
    <div className="flex-1">
      ...
      <div className="p-8 max-w-[1100px] mx-auto">
        <div className="flex items-start gap-16">
          <div className="flex-1">
            <h1 className="text-2xl font-bold">Aula 01 - Criando o projeto e realizado o setup inicial </h1>
            ...
            <div className="flex items-center gap-4 mt-6">
              ...
              alt="Professor Miguel Leite" 
              />

              <div className="leading-relaxed">
                <strong className="font-bold text-2xl block">Miguel Leite</strong>
